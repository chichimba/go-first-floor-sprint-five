...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	runCal := ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours)
	return runCal
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	walkCal := ((CaloriesWeightMultiplier*w.Weight + (math.Pow(w.meanSpeed()*KmHInMsec, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
	return walkCal
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	swimCal := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * float64(SwimmingCaloriesWeightMultiplier) * s.Weight * s.Duration.Hours()
	return swimCal
}
